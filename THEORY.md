...
If you want the full stack in one shot:
...
This will:
- run the drift demo
- show a sample GodScore run
- print a runtime monitor example
...
Most systems fail because they accumulate irreversible strain over time:
- slow drift
- compounding risk
- recovery loss
- hidden regressions
...
- **gate** unsafe changes (CI)
- **dampen** instability in runtime systems

---

## Papers / Derivations

- `PAPER.md` — “The God Variable: A Universal Scalar”
- `DERIVATION.md` — Λ / damping formulation and constraints
